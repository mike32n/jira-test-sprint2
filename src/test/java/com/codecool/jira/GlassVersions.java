...
public class GlassVersions {
    ...
    @Test(testName = "New Project Version In Glass")
    public static void newProjectVersionInGlass() throws InterruptedException, IOException {
        driver.manage().deleteAllCookies();
        driver.manage().window().maximize();
        driver.get("https://jira.codecool.codecanvas.hu/secure/Dashboard.jspa");
        Thread.sleep(500);
        ...
        Thread.sleep(500);
        driver.findElement(By.xpath("//form[@id='releases-add__version']/div/input")).sendKeys("Test PP1");
        driver.findElement(By.xpath("//form[@id='releases-add__version']/div[2]/input")).sendKeys("1/oct/20");
        driver.findElement(By.xpath("//form[@id='releases-add__version']/div[3]/input")).sendKeys("31/oct/20");
        driver.findElement(By.xpath("//form[@id='releases-add__version']/div[4]/input")).sendKeys("Test Description");
        Thread.sleep(500);
        driver.findElement(By.xpath("//form[@id='releases-add__version']/div[5]/button")).click();
        Thread.sleep(500);
        driver.findElement(By.linkText("Test PP1")).click();
